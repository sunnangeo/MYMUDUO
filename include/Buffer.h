...
{
public:
    static const size_t kCheapPrepend = 8;//数据包地长度
    static const size_t kInitialSize = 1024;//默认缓冲区的长度
...
private:
    char* begin() { return &*buffer_.begin(); } // it.operator*() vector底层数组首元素的地址，也就是数组的起始地址
